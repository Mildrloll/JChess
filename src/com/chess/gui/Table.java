...
public final class Table extends Observable {
    ...
    private JMenu createFileMenu() {
        ...
        openPGN.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                int option = chooser.showSaveDialog(Table.get().getGameFrame());
    ...
    private JMenu createPreferencesMenu() {
        ...
        final JMenu chessMenuChoiceSubMenu = new JMenu("Choose Chess Men Image Set");
        final JMenuItem abstractMenMenuItem = new JMenuItem("Abstract Men");
        chessMenuChoiceSubMenu.add(abstractMenMenuItem);
        abstractMenMenuItem.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                pieceIconPath = "art/pieces/plain/";
                Table.get().getBoardPanel().drawBoard(chessboard);
            }
        });
        preferencesMenu.add(chessMenuChoiceSubMenu);
